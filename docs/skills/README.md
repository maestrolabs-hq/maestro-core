...
This directory contains one page per skill. A skill is a `SKILL.md` contract
the agent harness loads and the agent invokes directly; none of them is
registered as an MCP server, and none is discovered as an executable on `PATH`.
